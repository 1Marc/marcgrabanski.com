...
<Image src={import("./_learning-paths.gif")} alt="Learning Paths" />
...
<Image src={import("./_video-annotations.png")} alt="Video Annotations" />
...
<Image src={import("./_statuses.png")} alt="Course Statuses" />
