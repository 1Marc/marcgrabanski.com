...
<Image src={import("./_grabanski-family.jpg")} alt="My Family 2022" />
...
This year I did a ton of health research to set up a system I can live by to live a healthy life. I distilled all that research into [My Personal Health Checklist](https://marcgrabanski.com/articles/personal-health-checklist/) that a world-renowned longevity doctor, Dr. Brad Steinfield, reviewed.
...
<a href="https://www.reddit.com/r/Gymnastics/comments/zvvwvo/first_15_years_of_gymnastics_age_38/">
...
<Image src={import("./_game-screenshot-2.jpg")} alt="Videogame Screenshot" />

<Image src={import("./_game-screenshot-4.jpg")} alt="Videogame Screenshot" />

<Image src={import("./_game-screenshot-1.jpg")} alt="Videogame Screenshot" />
...
<Image src={import("./_tough-mudder.jpg")} alt="Tough Mudder 8k" />
